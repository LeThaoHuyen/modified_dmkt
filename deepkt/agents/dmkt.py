...
class DMKTAgent(BaseAgent):
    ...
    def train_one_epoch(self, train_loader):
        ...
        for batch_idx, data in enumerate(tqdm(train_loader)):
            interactions, lec_interactions_list, questions, target_answers, target_mask, question_mask, lecture_mask = data
            ...
            output = self.model(questions, interactions, lec_interactions_list, question_mask, lecture_mask) 
        ...
        with torch.no_grad():
            for data in test_loader: # 1 batch
                if self.mode == 'test-post-test':
                    interactions, lec_interactions_list, questions, target_answers, target_mask, question_mask, lecture_mask, pt_questions = data
                ...
                if self.mode == 'test-post-test':
                    output = self.model(questions, interactions, lec_interactions_list, question_mask, lecture_mask,  pt_questions)
